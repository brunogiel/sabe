---
name: agentic-os-coach
description: >
  Es el punto de entrada de tu Personal Agentic OS: arma la base la primera vez, te ubica
  con una checklist, te enseña el concepto de cada escalón y te propone el próximo paso, uno
  por vez. Usalo cuando digas "/agentic-os-coach", "/coach", "coach", "agentic os coach", "second brain coach",
...
# Personal Agentic OS Coach: tu guía para crecer de a poco
...
- **(d) Ya es un Personal Agentic OS** (existen `ESTADO.md` + `ESCALERA.md` en la raíz): no preguntes nada, saltá al Paso 1.
